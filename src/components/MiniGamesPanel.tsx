...
const handleGamesMenu = () => {
  ...
  <div className="relative min-h-screen">
    ...
    {showGameCompleteNav && (
      <div className="fixed inset-x-0 bottom-0 z-[100] mx-auto max-w-md p-4">
        <div
    ...
    <p className="mt-1 text-sm font-black leading-none text-amber-100">
      {profile.coins}
            ...
            <div className="mt-3">
             ...
             <div className="relative h-2.5 w-full overflow-hidden rounded-full border border-cyan-400/10 bg-black/60">
  <div
