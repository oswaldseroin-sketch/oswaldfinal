...
>
  ...
  <div className="mb-7 flex items-start justify-between">
    ...
    <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-accent/10">
      ...
      {!questUnlocked ? (
  !mainDoorOpen ? (
    <div className="relative mt-6 flex min-h-[1100px] flex-col items-center">
      <button
  type="button"
  onClick={() => {
    setAdminPassword('')
...
>
  ...
  className="group relative z-20 mt-[170px] flex h-[180px] w-[128px] items-center justify-center overflow-hidden rounded-t-[120px] rounded-b-[28px] border-2 border-accent/80 bg-black/95 transition-all duration-300 active:scale-[0.97]"
  style={{
    boxShadow:
...
const doorTheme =
 ...
 slotNumber === 1
  ? 'left-[55px] top-[430px]'
  : slotNumber === 2
    ? 'right-[55px] top-[430px]'
    : slotNumber === 3
      ? 'left-[55px] top-[590px]'
      : 'right-[55px] top-[590px]'
  }`}
  style={{
...
slotNumber === 1
  ? 'left-1/2 top-[70px] -translate-x-1/2'
  : slotNumber === 2
    ? 'left-[45px] top-[355px]'
    : slotNumber === 3
      ? 'right-[45px] top-[355px]'
      : 'left-1/2 top-[640px] -translate-x-1/2'
}`}
      >
        <div
