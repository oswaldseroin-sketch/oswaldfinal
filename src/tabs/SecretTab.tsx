...
>
  ...
  className="group relative z-20 mt-[170px] flex h-[285px] w-[200px] items-center justify-center overflow-hidden rounded-t-[120px] rounded-b-[28px] border-2 border-accent/80 bg-black/95 transition-all duration-300 active:scale-[0.97]"
  style={{
    boxShadow:
